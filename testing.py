...
def initialize_voice():
    ...
    # Loop through available voices to find a British English voice
    selected_voice_index = 100  # Change this based on the output from the listing above
...
#instructions = {
#     1: "did a fold from the left edge of the paper to the right edge of the paper occur with a triangular shape at the end",
#     2: "is the paper a diamond shape with a crease down the middle",
#     3: "did the right edge get folded to align with the crease in the middle",
#     4:"did the left edge get folded to align with the crease in the middle",
#     5:"did the paper get rotated so that the wide end is at the bottom",
#     6: "did the bottom point of the paper get folded to meet the bottom of the two left and right front flaps",
#     7: "did the lower left and right diagonal edges get folded to align with the central vertical crease.",
#     8: "did the model get folded in half by bringing the bottom edge up.",
#     9: "did the front flap get folded back down, leaving a small overlap behind.",
...
if __name__ == "__main__":
    # WebSocket setup to send data to Unity
    #UDP_IP = "127.0.0.1"  # Unity IP
    #UDP_IP = "172.26.90.195"
